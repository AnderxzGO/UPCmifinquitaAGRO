    ...
    <header
            ...
            <div class="flex gap-5 text-black">
                ...
                <div class="flex items-center gap-2" v-for="category in products.categories" :key="category.id">
                    <input type="radio" name="category" :value="category.id"
                        class="h-4 w-4 rounded border-gray-300 text-green-600 focus:ring-emerald-500"
        ...
        <nav>
            ...
            <button v-else @click="auth.logout"
                class="rounded bg-green-500 hover:bg-green-600 transition-colors font-bold py-2 px-10">Iniciar
                Sesión</button>
