...
<template>
    <div class="flex gap-2 justify-center items-center">
        ...
        <h1 class="text-3xl font-black to-black">MI <span class="text-yellow-800">FINQUITA</span></h1>
    </div>
            ...
            <form @submit.prevent="iraregistro">
                ...
                <p class="text-center mt-4">
                    Si no tienes una Cuenta <span>
                        ...
                        <RouterLink to="/register" class="text-green-800 font-bold">Registrate</RouterLink>
                    </span>
                </p>
            </form>
        </div>
